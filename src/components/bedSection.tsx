...
export default function BedSection({ img, bgColor }: BedSectionProps) {
  return (
    ...
    >
      <div className="absolute -top-28 left-80 max-xl:left-1/2 max-xl:-translate-x-1/2 max-xl:transform max-xl:w-140 max-2xl:left-40">
        <Image src={img} alt="img" className="max-2xl:w-180" />
      </div>
      ...
      <div className="w-120 flex flex-col gap-5 items-start z-10 max-xl:text-center">
